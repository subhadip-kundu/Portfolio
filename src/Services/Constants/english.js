...
const englishJSON = {
	...
	about: {
		...
		paragraph1: (
			<>
				My name is Subhadip Kundu, I'm a <p>Frontend Developer</p> at Bankura, West Bengal. I love designing and developing applications that are very useful for people.
			</>
		),
		paragraph2:
